...
public class CommentController {
     ...
     * @return
     */
    @PostMapping("/xhsposts/{postId}/comments")
    ...
    @GetMapping("/xhsposts/{postId}/comments")
    public List<CommentDto> getCommentsByPostId(@PathVariable(value = "postId") Long postId) {
        return commentService.getCommentsByPostId(postId);
    }

    @GetMapping("/xhsposts/{postId}/comments/{id}")
    ...
    @PutMapping("/xhsposts/{postId}/comments/{id}")
    ...
    @DeleteMapping("/xhsposts/{postId}/comments/{id}")
